package com.elhazent.picodiploma.ojekonline.network;
...
import com.elhazent.picodiploma.ojekonline.model.ResponseWaitingDriver;
...
//
    ...
    @FormUrlEncoded
    @POST("get_booking")
    Call<ResponseHistoryReq> getDataHistory(
